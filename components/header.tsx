        ...
        const header = () => {
          return (
            ...
            <div className = "bg-[#1A365D] text-white justify-between flex">
              <div>
              <div className='flex'>
                <Image src={hamburger} alt = 'hamburger' className='w-20 h-10 lg:hidden xs:visible sm:visible  md:visible mx-5 my-7'></Image>
              
            <ul className = "flex mx-6 my-2">
              <Link href='/'><li className='my-1/2'><Image src ={logo} alt ="logo" width={80} height={80} className='md:mx-1 xs:mx-1 sm:mx-1'></Image></li></Link>
